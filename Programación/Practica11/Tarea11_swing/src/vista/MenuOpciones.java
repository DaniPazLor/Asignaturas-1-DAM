...
public class MenuOpciones extends JFrame {
    ...
    private void initComponents() {
        ...
        getAccessibleContext().setAccessibleDescription("APLICACIÓN NOTARÍA");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       NuevoCliente newCliente = new NuevoCliente();
       newCliente.setVisible(true);
       newCliente.setDefaultCloseOperation(JFrame.HIDE_ON_CLOSE);
